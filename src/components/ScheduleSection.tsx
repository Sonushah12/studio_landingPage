...
import { Calendar, Clock, MapPin, Users, Sparkles, Filter, CheckCircle2, ChevronRight } from 'lucide-react';
import { SCHEDULE_SLOTS } from '../data/studioData';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          <div>
            ...
            <p className="text-[#5A5854] text-sm mt-2 max-w-xl">
              Satellite, Ahmedabad campus. Select any day below to view morning and evening batch availability.
            </p>
          </div>
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-4 scrollbar-none">
          {days.map((day) => {
            ...
            const slotsCount = SCHEDULE_SLOTS.filter((s) => s.day === day).length;
        ...
        <div className="mt-8 space-y-3">
          {filteredSlots.length > 0 ? (
            filteredSlots.map((slot) => {
              const spotsPercentage = (slot.availableSpots / slot.totalSpots) * 100;
